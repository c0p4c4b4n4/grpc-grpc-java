...
public final class StreamingGreeterGrpc {
   ...
   */
  public static StreamingGreeterBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<StreamingGreeterBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<StreamingGreeterBlockingV2Stub>() {
        @java.lang.Override
        public StreamingGreeterBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new StreamingGreeterBlockingV2Stub(channel, callOptions);
        }
      };
    return StreamingGreeterBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public static final class StreamingGreeterBlockingV2Stub
    ...
    private StreamingGreeterBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected StreamingGreeterBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new StreamingGreeterBlockingV2Stub(channel, callOptions);
    }
    ...
    public io.grpc.stub.BlockingClientCall<io.grpc.examples.manualflowcontrol.HelloRequest, io.grpc.examples.manualflowcontrol.HelloReply>
      ...
      return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(
          getChannel(), getSayHelloStreamingMethod(), getCallOptions());
    }
  }

  /**
   * A stub to allow clients to do limited synchronous rpc calls to service StreamingGreeter.
   * <pre>
   * The greeting service definition.
   * </pre>
   */
