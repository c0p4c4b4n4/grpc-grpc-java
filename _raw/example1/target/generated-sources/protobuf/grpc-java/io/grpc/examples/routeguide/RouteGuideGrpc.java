...
public final class RouteGuideGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "routeguide.RouteGuide";
   ...
   */
  public static RouteGuideBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<RouteGuideBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<RouteGuideBlockingV2Stub>() {
        @java.lang.Override
        public RouteGuideBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new RouteGuideBlockingV2Stub(channel, callOptions);
        }
      };
    return RouteGuideBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getFeature(io.grpc.examples.routeguide.Point request,
     ...
     * </pre>
     */
    default void listFeatures(io.grpc.examples.routeguide.Rectangle request,
        io.grpc.stub.StreamObserver<io.grpc.examples.routeguide.Feature> responseObserver) {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<io.grpc.examples.routeguide.Point> recordRoute(
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<io.grpc.examples.routeguide.RouteNote> routeChat(
   ...
   * </pre>
   */
  public static final class RouteGuideBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<RouteGuideBlockingV2Stub> {
    private RouteGuideBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RouteGuideBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new RouteGuideBlockingV2Stub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public io.grpc.examples.routeguide.Feature getFeature(io.grpc.examples.routeguide.Point request) throws io.grpc.StatusException {
    ...
    public io.grpc.stub.BlockingClientCall<?, io.grpc.examples.routeguide.Feature>
        listFeatures(io.grpc.examples.routeguide.Rectangle request) {
     ...
     */
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
    public io.grpc.stub.BlockingClientCall<io.grpc.examples.routeguide.Point, io.grpc.examples.routeguide.RouteSummary>
        recordRoute() {
      return io.grpc.stub.ClientCalls.blockingClientStreamingCall(
          getChannel(), getRecordRouteMethod(), getCallOptions());
    }
     ...
     */
    @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/10918")
    public io.grpc.stub.BlockingClientCall<io.grpc.examples.routeguide.RouteNote, io.grpc.examples.routeguide.RouteNote>
        routeChat() {
      return io.grpc.stub.ClientCalls.blockingBidiStreamingCall(
          getChannel(), getRouteChatMethod(), getCallOptions());
    }
  }

  /**
   * A stub to allow clients to do limited synchronous rpc calls to service RouteGuide.
   * <pre>
   * Interface exported by the server.
   * </pre>
   */
