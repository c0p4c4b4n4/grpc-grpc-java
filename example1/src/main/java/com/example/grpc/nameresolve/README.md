...
The client registers an implementation of a **name resolver provider** to a process-global **registry** close to the
start of the process.
The name resolver provider will be called by the **gRPC library** with a **target strings** intended for the custom name
resolver.
