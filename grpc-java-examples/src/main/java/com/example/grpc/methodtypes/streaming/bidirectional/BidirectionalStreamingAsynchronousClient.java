...
public class BidirectionalStreamingAsynchronousClient {

    private static final Logger logger = Logger.getLogger(BidirectionalStreamingAsynchronousClient.class.getName());
